        ...
        <section>
            ...
            <form action="index.php" method="get">
                <div class="form-group<?= isset($errors['tableErrors']) ? ' has-error' : '' ?>">
                    ...
                    <input class="form-control" id="nbtables" type="text" name="nbtables" value="<?= $tableCount ?>">
                ...
                <div class="form-group<?= isset($errors['valueErrors']) ? ' has-error' : '' ?>">
                    ...
                    <input class="form-control" id="nbvaleurs" type="text" name="nbvaleurs" value="<?= $valueCount ?>">
